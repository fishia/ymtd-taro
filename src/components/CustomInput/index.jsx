...
class HdInput extends AtInput {
  ...
  render() {
    ...
    return React.createElement(
      ...
      {
        className: rootCls,
        style: error ? { ...customStyle, borderBottom: '1px solid #F7461D' } : customStyle,
      },
      React.createElement(
        View,
        ...
        title &&
          React.createElement(
            Label,
            { className: `at-input__title ${required && 'at-input__title--required'}`, for: name },
            title
          ),
        ...
        clear &&
          ...
          React.createElement(
            View,
            { className: 'at-input__icon', onTouchEnd: this.handleClearValue },
